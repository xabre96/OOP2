...
<div class="movie-list">
    ...
    <a href="<?php echo base_url('myfunctions/GuestSelectedCategoryPage/'.$genres->movie_category); ?>"><?php echo $genres->movie_category; ?></a></br>
    <?php endforeach; ?>
...
<div class="movie-post">
    ...
    <?php  foreach ($movie_list->result() as $movie) : ?>
        <div class="movie-container">
            <div class="thumbnail">
                <a href="<?php echo base_url('myfunctions/GuestSelectedMoviePage/'.$movie->movie_id); ?>"><img height="300" width="185"   value="lala" href="Click to show details." src="<?php echo base_url('uploads/'.$movie->userfile.''); ?>"/> </a>
                <div class="caption">
