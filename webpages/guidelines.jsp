        ...
        <div class="container">
            ...
            <div class="navbar"> 
                ...
                <ul>
                    ...
                    <li><a id="active" href="guidelines.jsp">Guidelines</a></li>
                    <li><a id="" href="aboutUs.jsp">About Us</a></li>
                    <li><a id="" href="login.jsp">Login</a></li>
            ...
            <div class="movie-list">
                <div class="movie-categories">
                    ...
                    <h3>Barangays</h3>
                    <%
                        rs = st.executeQuery("SELECT baranggay FROM table_baranggay");
                        while (rs.next()) {
                    %>
                    <a href="#"><% out.println(rs.getString("baranggay"));%></a></br>
                    <%
                        }
                        rs.close();
                        st.close();
