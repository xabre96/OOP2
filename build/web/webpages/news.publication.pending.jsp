...
<html lang="en">
    ...
    <ul>
         ...
         <li><a id="active" href="../webpages/news.publication.pending.jsp">Pending Reports</a></li>
...
ResultSet rs  = st.executeQuery("SELECT * FROM table_news WHERE news_status = 'Pending'");
while (rs.next()) {
...
String news_status = rs.getString("news_status"); 
            ...
            %>
      <tr>
        <td><% out.println(news_title); %></td>
        <td><% out.println(news_content); %></td>
        <td><% out.println(news_author); %></td>
        <td><% out.println(news_status); %></td>
        
            
       <form action="../functions/update.status.jsp" method="POST">
