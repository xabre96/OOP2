    ...
    <div class="body-movie1" style="margin-left:250px;">
      <p align='center'></p>        
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <h5>News Title:</h5>
              <input type="text" class="form-control" id="movie_title" name="news_title" placeholder="News Title" required/>
            </div>
          </div>
      ...
      <div class="body-movie1"  >      
        <div class="form-group">
          ...
          <div class="col-sm-10"> 
          <h5>Content:</h5>         
            <textarea style=" margin-bottom:10px;" cols="100" rows="15" type="text" class="form-control" id="movie_description" name="news_content" Placeholder="..." size="30" required></textarea>
          </div>
        </div>
