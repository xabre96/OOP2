  ...
  <form class="form-horizontal" action="../functions/update.jsp" method="post">
    <div class="body-movie1" style="margin-left:250px;">
      <p align='center'></p>       
              ...
              <input type="hidden" class="form-control" id="movie_title" name="news_id" value="<% out.println(news_id); %>" placeholder="Title">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <h5>News Title:</h5>
              <input type="text" class="form-control" id="movie_title" name="news_title" value="<% out.println(news_title); %>" placeholder="Title">
            </div>
          </div>
      ...
      <div class="body-movie1"  >      
        <div class="form-group">
          ...
          <div class="col-sm-10"> 
          <h5>Content:</h5>         
            <textarea style=" margin-bottom:10px;" cols="100" rows="15" type="text" class="form-control" id="movie_description" name="news_content" Placeholder="..." value="<% out.println(news_content); %>" size="30" ></textarea>
          </div>
        </div>
